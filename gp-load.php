...
if ( version_compare( PHP_VERSION, '5.2', '<' ) ) {
	die( sprintf( "Your server is running PHP version %s but laaam requires at least 5.2.\n", PHP_VERSION ) );
}
...
if ( defined( 'GP_CONFIG_FILE' ) && GP_CONFIG_FILE ) {
	...
	header('Location: '.preg_replace( '|/[^/]+?$|', '/', $_SERVER['PHP_SELF'] ) . 'cmanager/public/index.php/laaam/install');
